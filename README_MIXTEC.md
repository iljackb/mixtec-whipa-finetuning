...
Custom pipeline for fine-tuning [WhIPA](https: //github.com/jshrdt/whipa) (a Whisper-based speech-to-IPA model) on Mixtepec Mixtec, an under-resourced Otomanguean language with no prior representation in WhIPA's training data.
